...
function check(context) {
    ...
    var telephone1 = Xrm.Page.getAttribute("telephone1").getValue();
    ...
    if (phone == null || !isNameValid("mobilephone", "^[0-9]") || phone.length < 8 || phone.length > 11) {
    ...
    if (!isNameValid("telephone1", "^[0-9]") || (telephone1.length > 0 && telephone1.length < 8) || telephone1.length > 0 && telephone1.length > 11) {
        alert("Other Phone 1 must be 8-11 numeric characters!");
        Xrm.Page.ui.controls.get("telephone1").setFocus(true);
        context.getEventArgs().preventDefault();
        return;
    }

    if (!isNameValid("telephone2", "^[0-9]") || (telephone2.length > 0 && telephone2.length < 8) || telephone2.length > 0 && telephone2.length > 11) {
        alert("Other Phone 2 must be 8-11 numeric characters!");
        Xrm.Page.ui.controls.get("telephone2").setFocus(true);
        context.getEventArgs().preventDefault();
        return;
    }
